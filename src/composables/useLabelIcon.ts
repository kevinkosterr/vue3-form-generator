 ...
 */
export function useLabelIcon(iconDefinition: string | LabelIconDefinition | Component | undefined) {

  /**
   * The icon that should be displayed with a label.
   * If no icon is defined, return null.
   */
  const labelIcon: ComputedRef<string | Component | null> = computed(() => {
    ...
    return (iconDefinition as Component | string)
  })
